...
```typescript
import { LibraryServiceCreateContextPatchAutoApproveRuleRequest } from "@textql/sdk/models/operations";

let value: LibraryServiceCreateContextPatchAutoApproveRuleRequest = {
  body: {},
};
```
