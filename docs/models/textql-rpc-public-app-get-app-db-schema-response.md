...
| `changeLogBytes`                                                                         | *models.TextqlRpcPublicAppGetAppDBSchemaResponseChangeLogBytes*                          | :heavy_minus_sign:                                                                       | durable Postgres change-log size; the .duckdb cache is derived from this                 |