...
| `avgHitRate`                                                                                    | *number*                                                                                        | :heavy_minus_sign:                                                                              | 0..1, averaged over pulled .tql files with chat-attributed pulls                                |
...
| `tqlPulledFiles`                                                                                | *number*                                                                                        | :heavy_minus_sign:                                                                              | .tql files behind avg_hit_rate; 0 = rate has no signal                                          |
| `avgDocCitedRate`                                                                               | *number*                                                                                        | :heavy_minus_sign:                                                                              | 0..1 cited-when-pulled over pulled docs (excludes .tql and config-managed .playbook/.dashboard) |
| `docPulledFiles`                                                                                | *number*                                                                                        | :heavy_minus_sign:                                                                              | docs behind avg_doc_cited_rate; 0 = rate has no signal                                          |
| `docCitationsEnabled`                                                                           | *boolean*                                                                                       | :heavy_minus_sign:                                                                              | source attribution active for this org (traces enabled)                                         |