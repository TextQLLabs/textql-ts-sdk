...
```typescript
import { TextqlRpcPublicSecretMigrateSecretToApiConnectorResponse } from "@textql/sdk/models";

let value: TextqlRpcPublicSecretMigrateSecretToApiConnectorResponse = {
  apiAccessKey: {
