...
async function run() {
  const result = await textql.appService.appServiceGetAppMemberState({
    body: {},
  });
...
import { appServiceAppServiceGetAppMemberState } from "@textql/sdk/funcs/app-service-app-service-get-app-member-state.js";
...
async function run() {
  const res = await appServiceAppServiceGetAppMemberState(textql, {
    body: {},
  });
  if (res.ok) {
    ...
    console.log("appServiceAppServiceGetAppMemberState failed:", res.error);
  }
}
...
async function run() {
  const result = await textql.appService.appServiceListAppActivitySince({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { appServiceAppServiceListAppActivitySince } from "@textql/sdk/funcs/app-service-app-service-list-app-activity-since.js";
...
async function run() {
  const res = await appServiceAppServiceListAppActivitySince(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("appServiceAppServiceListAppActivitySince failed:", res.error);
  }
}
...
async function run() {
  const result = await textql.appService.appServiceListMyAppMemberActivity({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { appServiceAppServiceListMyAppMemberActivity } from "@textql/sdk/funcs/app-service-app-service-list-my-app-member-activity.js";
...
async function run() {
  const res = await appServiceAppServiceListMyAppMemberActivity(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("appServiceAppServiceListMyAppMemberActivity failed:", res.error);
  }
}
...
async function run() {
  const result = await textql.appService.appServicePresenceHeartbeat({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { appServiceAppServicePresenceHeartbeat } from "@textql/sdk/funcs/app-service-app-service-presence-heartbeat.js";
...
async function run() {
  const res = await appServiceAppServicePresenceHeartbeat(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("appServiceAppServicePresenceHeartbeat failed:", res.error);
  }
}
...
async function run() {
  const result = await textql.appService.appServiceRecordAppMemberActivity({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { appServiceAppServiceRecordAppMemberActivity } from "@textql/sdk/funcs/app-service-app-service-record-app-member-activity.js";
...
async function run() {
  const res = await appServiceAppServiceRecordAppMemberActivity(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("appServiceAppServiceRecordAppMemberActivity failed:", res.error);
  }
}
...
async function run() {
  const result = await textql.appService.appServiceSetAppMemberState({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { appServiceAppServiceSetAppMemberState } from "@textql/sdk/funcs/app-service-app-service-set-app-member-state.js";
...
async function run() {
  const res = await appServiceAppServiceSetAppMemberState(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("appServiceAppServiceSetAppMemberState failed:", res.error);
  }
}
