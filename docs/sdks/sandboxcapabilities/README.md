...
<!-- UsageSnippet language="typescript" operationID="SandboxCapabilityService_Deliver" method="post" path="/textql.rpc.public.sandbox_capability.SandboxCapabilityService/Deliver" -->
```typescript
...
async function run() {
  const result = await textql.sandboxCapabilities.deliver({
    body: {},
  });
...
import { sandboxCapabilitiesDeliver } from "@textql/sdk/funcs/sandbox-capabilities-deliver.js";
...
async function run() {
  const res = await sandboxCapabilitiesDeliver(textql, {
    body: {},
  });
  if (res.ok) {
    ...
    console.log("sandboxCapabilitiesDeliver failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.SandboxCapabilityServiceDeliverRequest](../../models/operations/sandbox-capability-service-deliver-request.md)                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.SandboxCapabilityServiceDeliverResponse](../../models/operations/sandbox-capability-service-deliver-response.md)\>**
