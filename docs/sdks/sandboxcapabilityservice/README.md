...
* [sandboxCapabilityServicePollAsk](#sandboxcapabilityservicepollask) - PollAsk
...
* [sandboxCapabilityServiceStartAsk](#sandboxcapabilityservicestartask) - StartAsk
...
## sandboxCapabilityServicePollAsk
...
async function run() {
  const result = await textql.sandboxCapabilityService.sandboxCapabilityServicePollAsk({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { sandboxCapabilityServiceSandboxCapabilityServicePollAsk } from "@textql/sdk/funcs/sandbox-capability-service-sandbox-capability-service-poll-ask.js";
...
async function run() {
  const res = await sandboxCapabilityServiceSandboxCapabilityServicePollAsk(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("sandboxCapabilityServiceSandboxCapabilityServicePollAsk failed:", res.error);
  }
}
...
## sandboxCapabilityServiceStartAsk
...
async function run() {
  const result = await textql.sandboxCapabilityService.sandboxCapabilityServiceStartAsk({
    body: {},
  });
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { sandboxCapabilityServiceSandboxCapabilityServiceStartAsk } from "@textql/sdk/funcs/sandbox-capability-service-sandbox-capability-service-start-ask.js";
...
async function run() {
  const res = await sandboxCapabilityServiceSandboxCapabilityServiceStartAsk(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("sandboxCapabilityServiceSandboxCapabilityServiceStartAsk failed:", res.error);
  }
}
