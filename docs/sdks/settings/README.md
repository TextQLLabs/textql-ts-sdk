...
* [checkMemberStatus](#checkmemberstatus) - CheckMemberStatus
* [deleteMember](#deletemember) - DeleteOrganizationMember
...
import { settingsCheckMemberStatus } from "@textql/sdk/funcs/settings-check-member-status.js";
...
async function run() {
  const res = await settingsCheckMemberStatus(textql, {
    body: {},
  });
  if (res.ok) {
    ...
    console.log("settingsCheckMemberStatus failed:", res.error);
  }
}
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { settingsDeleteMember } from "@textql/sdk/funcs/settings-delete-member.js";
...
async function run() {
  const res = await settingsDeleteMember(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("settingsDeleteMember failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="SettingsService_GetOrganizationSettings" method="post" path="/textql.rpc.public.settings.SettingsService/GetOrganizationSettings" -->
```typescript
import { Textql } from "@textql/sdk";
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { settingsGet } from "@textql/sdk/funcs/settings-get.js";
...
async function run() {
  const res = await settingsGet(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.SettingsServiceGetOrganizationSettingsRequest](../../models/operations/settings-service-get-organization-settings-request.md)                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.SettingsServiceGetOrganizationSettingsResponse](../../models/operations/settings-service-get-organization-settings-response.md)\>**
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { settingsInviteMember } from "@textql/sdk/funcs/settings-invite-member.js";
...
async function run() {
  const res = await settingsInviteMember(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("settingsInviteMember failed:", res.error);
  }
}
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { settingsListMembers } from "@textql/sdk/funcs/settings-list-members.js";
...
async function run() {
  const res = await settingsListMembers(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("settingsListMembers failed:", res.error);
  }
}
...
```typescript
import { TextqlCore } from "@textql/sdk/core.js";
import { settingsUpdate } from "@textql/sdk/funcs/settings-update.js";
...
async function run() {
  const res = await settingsUpdate(textql, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
