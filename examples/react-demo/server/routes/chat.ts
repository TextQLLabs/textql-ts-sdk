import { CHAT_MODEL_IDS, DEFAULT_CHAT_MODEL } from '../../src/lib/chatModels';
...
const sendChat: RequestHandler = async ({ request }) => {
...
export const chatRoute: RouteHandlers = { POST: sendChat };
