 ...
 */
export function appServiceAppServiceGetAppDBSchema(
  client: TextqlCore,
  request: operations.AppServiceGetAppDBSchemaRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppServiceGetAppDBSchemaResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.AppServiceGetAppDBSchemaRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/textql.rpc.public.app.AppService/GetAppDBSchema")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppServiceGetAppDBSchemaResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.AppServiceGetAppDBSchemaResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
