 ...
 */
export function appServiceAppServiceGetAppDBTablePreview(
  client: TextqlCore,
  request: operations.AppServiceGetAppDBTablePreviewRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppServiceGetAppDBTablePreviewResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceGetAppDBTablePreviewRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AppServiceGetAppDBTablePreviewResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
