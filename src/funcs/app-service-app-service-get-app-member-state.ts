...
export function appServiceAppServiceGetAppMemberState(
  ...
  Result<
    operations.AppServiceGetAppMemberStateResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceGetAppMemberStateRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppServiceGetAppMemberStateResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.AppServiceGetAppMemberStateResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
