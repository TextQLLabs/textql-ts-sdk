...
export function appServiceAppServiceListAppActivitySince(
  ...
  Result<
    operations.AppServiceListAppActivitySinceResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceListAppActivitySinceRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AppServiceListAppActivitySinceResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
