 ...
 */
export function appServiceAppServiceListMyAppMemberActivity(
  client: TextqlCore,
  request: operations.AppServiceListMyAppMemberActivityRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppServiceListMyAppMemberActivityResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceListMyAppMemberActivityRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AppServiceListMyAppMemberActivityResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
