...
export function appServiceAppServicePresenceHeartbeat(
  ...
  Result<
    operations.AppServicePresenceHeartbeatResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServicePresenceHeartbeatRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "AppService_PresenceHeartbeat",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppServicePresenceHeartbeatResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.AppServicePresenceHeartbeatResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
