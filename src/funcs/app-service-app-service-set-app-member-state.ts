 ...
 */
export function appServiceAppServiceSetAppMemberState(
  client: TextqlCore,
  request: operations.AppServiceSetAppMemberStateRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AppServiceSetAppMemberStateResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceSetAppMemberStateRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/textql.rpc.public.app.AppService/SetAppMemberState",
  )();
  ...
  const context = {
    ...
    operationID: "AppService_SetAppMemberState",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AppServiceSetAppMemberStateResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.AppServiceSetAppMemberStateResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
