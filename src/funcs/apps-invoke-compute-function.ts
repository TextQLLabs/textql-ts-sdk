...
export function appsInvokeComputeFunction(
  ...
  Result<
    operations.AppServiceInvokeAppComputeFunctionResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.AppServiceInvokeAppComputeFunctionRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AppServiceInvokeAppComputeFunctionResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
