...
export function chatsApproveOntologyChange(
  ...
  Result<
    operations.ChatServiceApproveOntologyChangeResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ChatServiceApproveOntologyChangeRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ChatServiceApproveOntologyChangeResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
