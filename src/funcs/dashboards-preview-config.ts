 ...
 */
export function dashboardsPreviewConfig(
  client: TextqlCore,
  request: operations.DashboardServicePreviewConfigDashboardRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DashboardServicePreviewConfigDashboardResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DashboardServicePreviewConfigDashboardRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.DashboardServicePreviewConfigDashboardResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
