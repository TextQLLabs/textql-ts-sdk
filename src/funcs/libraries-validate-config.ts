 ...
 */
export function librariesValidateConfig(
  client: TextqlCore,
  request: operations.LibraryServiceValidateConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LibraryServiceValidateConfigResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LibraryServiceValidateConfigRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/textql.rpc.public.patches.LibraryService/ValidateConfig",
  )();
  ...
  const context = {
    ...
    operationID: "LibraryService_ValidateConfig",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LibraryServiceValidateConfigResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
      "default",
      operations.LibraryServiceValidateConfigResponse$inboundSchema,
    ),
  )(response, req);
  if (!result.ok) {
