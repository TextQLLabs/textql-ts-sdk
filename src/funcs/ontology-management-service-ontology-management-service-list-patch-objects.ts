 ...
 */
export function ontologyManagementServiceOntologyManagementServiceListPatchObjects(
  client: TextqlCore,
  request: operations.OntologyManagementServiceListPatchObjectsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OntologyManagementServiceListPatchObjectsResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .OntologyManagementServiceListPatchObjectsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/textql.rpc.public.patches.OntologyManagementService/ListPatchObjects",
  )();
  ...
  const context = {
    ...
    operationID: "OntologyManagementService_ListPatchObjects",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .OntologyManagementServiceListPatchObjectsResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
