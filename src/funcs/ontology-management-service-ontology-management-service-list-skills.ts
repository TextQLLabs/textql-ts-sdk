 ...
 */
export function ontologyManagementServiceOntologyManagementServiceListSkills(
  client: TextqlCore,
  request: operations.OntologyManagementServiceListSkillsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OntologyManagementServiceListSkillsResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.OntologyManagementServiceListSkillsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/textql.rpc.public.patches.OntologyManagementService/ListSkills",
  )();
  ...
  const context = {
    ...
    operationID: "OntologyManagementService_ListSkills",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.OntologyManagementServiceListSkillsResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
