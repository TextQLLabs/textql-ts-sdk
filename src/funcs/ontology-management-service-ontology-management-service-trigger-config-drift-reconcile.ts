 ...
 */
export function ontologyManagementServiceOntologyManagementServiceTriggerConfigDriftReconcile(
  client: TextqlCore,
  request:
...
> {
  ...
  const path = pathToFunc(
    "/textql.rpc.public.patches.OntologyManagementService/TriggerConfigDriftReconcile",
  )();
  ...
  const context = {
    ...
    operationID: "OntologyManagementService_TriggerConfigDriftReconcile",
    oAuth2Scopes: null,
