 ...
 */
export function ontologyManagementServiceOntologyManagementServiceValidateConfig(
  client: TextqlCore,
  request: operations.OntologyManagementServiceValidateConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.OntologyManagementServiceValidateConfigResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .OntologyManagementServiceValidateConfigRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/textql.rpc.public.patches.OntologyManagementService/ValidateConfig",
  )();
  ...
  const context = {
    ...
    operationID: "OntologyManagementService_ValidateConfig",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.OntologyManagementServiceValidateConfigResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
