 ...
 */
export function sandboxAdminListSandboxEgress(
  client: TextqlCore,
  request: operations.SandboxAdminServiceListSandboxEgressRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SandboxAdminServiceListSandboxEgressResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SandboxAdminServiceListSandboxEgressRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SandboxAdminServiceListSandboxEgressResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
