 ...
 */
export function sandboxAdminListSandboxFiles(
  client: TextqlCore,
  request: operations.SandboxAdminServiceListSandboxFilesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SandboxAdminServiceListSandboxFilesResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SandboxAdminServiceListSandboxFilesRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SandboxAdminServiceListSandboxFilesResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
