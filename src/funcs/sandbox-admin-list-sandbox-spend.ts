 ...
 */
export function sandboxAdminListSandboxSpend(
  client: TextqlCore,
  request: operations.SandboxAdminServiceListSandboxSpendRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SandboxAdminServiceListSandboxSpendResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SandboxAdminServiceListSandboxSpendRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SandboxAdminServiceListSandboxSpendResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
