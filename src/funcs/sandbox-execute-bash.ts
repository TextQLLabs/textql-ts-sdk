 ...
 * Runs in the caller's own worker; no connector/source scoping.
 */
export function sandboxExecuteBash(
  client: TextqlCore,
  request: operations.SandboxQueryServiceExecuteBashRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SandboxQueryServiceExecuteBashResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SandboxQueryServiceExecuteBashRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SandboxQueryServiceExecuteBashResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
