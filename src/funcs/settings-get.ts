...
export function settingsGet(
  ...
  Result<
    operations.SettingsServiceGetOrganizationSettingsResponse,
    | TextqlError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SettingsServiceGetOrganizationSettingsRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SettingsServiceGetOrganizationSettingsResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json(
