...
/** @internal */
export const TextqlRpcPublicAppAppVersion$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicAppAppVersionFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicAppAppVersion, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicAppAppVersion$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicAppAppVersion' from JSON`,
  );
}
