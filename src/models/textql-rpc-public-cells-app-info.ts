...
/** @internal */
export const TextqlRpcPublicCellsAppInfo$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicCellsAppInfoFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicCellsAppInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicCellsAppInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicCellsAppInfo' from JSON`,
  );
}
