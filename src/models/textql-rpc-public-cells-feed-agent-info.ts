...
export type TextqlRpcPublicCellsFeedAgentInfo = {
  id?: string | undefined;
...
/** @internal */
export const TextqlRpcPublicCellsFeedAgentInfo$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicCellsFeedAgentInfoFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicCellsFeedAgentInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicCellsFeedAgentInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicCellsFeedAgentInfo' from JSON`,
  );
}
