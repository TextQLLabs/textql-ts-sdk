...
export type TextqlRpcPublicObserveAppBillingStat = {
...
/** @internal */
export const TextqlRpcPublicObserveAppBillingStat$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicObserveAppBillingStatFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicObserveAppBillingStat, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      TextqlRpcPublicObserveAppBillingStat$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicObserveAppBillingStat' from JSON`,
  );
}
