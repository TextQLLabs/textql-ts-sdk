...
/** @internal */
export const TextqlRpcPublicPatchesOntologyRemote$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicPatchesOntologyRemoteFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicPatchesOntologyRemote, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      TextqlRpcPublicPatchesOntologyRemote$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicPatchesOntologyRemote' from JSON`,
  );
}
