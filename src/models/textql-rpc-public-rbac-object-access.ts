...
export type TextqlRpcPublicRbacObjectAccess = {
  id?: string | undefined;
...
/** @internal */
export const TextqlRpcPublicRbacObjectAccess$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicRbacObjectAccessFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicRbacObjectAccess, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicRbacObjectAccess$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicRbacObjectAccess' from JSON`,
  );
}
