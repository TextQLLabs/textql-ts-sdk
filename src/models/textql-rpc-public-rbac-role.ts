...
/** @internal */
export const TextqlRpcPublicRbacRole$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicRbacRoleFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicRbacRole, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicRbacRole$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicRbacRole' from JSON`,
  );
}
