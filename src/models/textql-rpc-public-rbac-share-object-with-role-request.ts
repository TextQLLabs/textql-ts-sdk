...
/** @internal */
export const TextqlRpcPublicRbacShareObjectWithRoleRequest$outboundSchema:
  z.ZodMiniType<
...
export function textqlRpcPublicRbacShareObjectWithRoleRequestToJSON(
  textqlRpcPublicRbacShareObjectWithRoleRequest:
    TextqlRpcPublicRbacShareObjectWithRoleRequest,
): string {
  return JSON.stringify(
    TextqlRpcPublicRbacShareObjectWithRoleRequest$outboundSchema.parse(
      textqlRpcPublicRbacShareObjectWithRoleRequest,
    ),
  );
}
