...
/** @internal */
export const TextqlRpcPublicRbacSharedObject$inboundSchema: z.ZodMiniType<
...
export function textqlRpcPublicRbacSharedObjectFromJSON(
  jsonString: string,
): SafeParseResult<TextqlRpcPublicRbacSharedObject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextqlRpcPublicRbacSharedObject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextqlRpcPublicRbacSharedObject' from JSON`,
  );
}
